...
public class DrawViewingPath : MonoBehaviour
{
    string line;
    ...
    void Start()
    {
        ...
        heatPath = @"D:\v.kakerbeck\Tracking\Heatmap3D\3DHeatmap_VP" + VPNum + ".txt";
        //read in position file -> to calculate hit points
        System.IO.StreamReader positions = new System.IO.StreamReader(@"D:\v.kakerbeck\Tracking\Position\positions_VP"+VPNum +".txt");
        ...
        if (!randomizeGaze)
        {
            System.IO.StreamReader EyeBoxPos = new System.IO.StreamReader(@"D:\v.kakerbeck\Tracking\EyeBoxPos\EyeBoxPos_VP" + VPNum + ".txt");
            ...
            System.IO.StreamReader EyesOnScreen = new System.IO.StreamReader(@"D:\v.kakerbeck\Tracking\EyesOnScreen\EyesOnScreen_VP" + VPNum + ".txt");
        ...
        else//create random eyeGazes while keeping the players position
        {
            for (int n = 0; n<positionL.Count; n++)
            {
                ...
                heatPath = @"D:\v.kakerbeck\Tracking\Heatmap3D\3DHeatmapRandomGaze_VP" + VPNum + ".txt";
            }        
        }
        ...
        {
            heatPath = @"D:\v.kakerbeck\Tracking\Heatmap3D\3DHeatmapRandomPos_VP" + VPNum + ".txt";
        ...
        {
            using (StreamWriter writer = new StreamWriter(@"D:\v.kakerbeck\Tracking\ViewedHouses\ViewedHouses_VP" + VPNum + ".txt"))//save viewedHouses
            {
